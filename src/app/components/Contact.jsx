    ...
    <section className="my-25 sm:my-25 flex flex-col items-center justify-start px-5 sm:px-10" id="contact">
      <div className="max-w-2xl w-full flex flex-col gap-3">
        ...
        <div className="flex  gap-6 mt-5 text-2xl text-neutral-400">
          <a href="https://github.com/Ayush2004sharma" target="_blank" className="hover:text-pink-200">
            <FaGithub />
          </a>
          <a href="https://www.linkedin.com/in/ayush-sharma-engineer/" target="_blank" className="hover:text-blue-300">
            <FaLinkedin />
          </a>
        </div>
      </div>
